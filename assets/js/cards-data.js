...
export const oppressorsCard = [
  ...
  },
  {
    ...
    short:
      "Colonial Official — Early protector turned cautious under friar pressure.",
  ...
  },
  {
    ...
    short:
      "Religious Opposition — Jesuit debater in theological correspondence.",
...
export const movementCard = [
  {
    ...
    short:
      "Movement — Filipino reformist campaign in Spain for equality under the law.",
...
export const reformistCard = [
  {
    ...
    short:
      "Revolutionary Thinker — The “Brains of the Revolution” who admired Rizal’s ideals.",
  ...
  },
  {
    ...
    short:
      "Revolutionary Leader — Katipunan founder inspired by Rizal’s patriotism.",
  ...
  },
  {
    ...
    short:
      "Reformist — Early La Liga Filipina member supporting Rizal’s reforms.",
  ...
  },
  {
    ...
    short:
      "Civic Leader — Mason who advanced Rizal’s principles of unity and progress.",
